...
void main() {
  group('Valid Data Creation', () {
    test('should create valid VietQrData with minimal required fields', () {
      ...
      expect(data.merchantAccInfo.beneficiaryOrgData.bankBinCode, equals('970436'));
      expect(data.merchantAccInfo.beneficiaryOrgData.bankAccount, equals('1234567890'));
    ...
    test('should create VietQrData with all optional fields', () {
      ...
      // Assert
      expect(data.version, equals('01'));
      expect(data.merchantAccInfo.beneficiaryOrgData.bankBinCode, equals('970407'));
      expect(data.merchantAccInfo.beneficiaryOrgData.bankAccount, equals('1111222233334444'));
    ...
    test('should create VietQrData with custom constructor', () {
      ...
      // Assert
      expect(data.merchantAccInfo.beneficiaryOrgData.bankBinCode, equals('970422'));
      expect(data.merchantAccInfo.beneficiaryOrgData.bankAccount, equals('5555666677778888'));
  ...
  group('Field Validation Tests', () {
    ...
    test('should validate globalUid length correctly', () {
      ...
      expect(data.initiationMethod, equals('12')); // Dynamic QR for empty amount
    });

    test('should throw InvalidLengthException for invalid merchant category length', () {
      // Arrange
      final data = VietQrData(
        bankBinCode: SupportedBank.vietcombank,
        bankAccount: '1234567890',
    ...
    test('should throw InvalidLengthException for invalid country code length', () {
      // Arrange
      final data = VietQrData(
        bankBinCode: SupportedBank.vietcombank,
        bankAccount: '1234567890',
    ...
    test('should throw MaxLengthExceededCharException for too long amount', () {
      ...
      // Act & Assert
      expect(() => data.validate(), throwsA(isA<MaxLengthExceededCharException>()));
    });
    ...
    test('should throw MaxLengthExceededCharException for too long merchant name', () {
      // Arrange
      final data = VietQrData(
        bankBinCode: SupportedBank.vietcombank,
        bankAccount: '1234567890',
    ...
    test('should throw MaxLengthExceededCharException for too long merchant city', () {
      // Arrange
      final data = VietQrData(
        bankBinCode: SupportedBank.vietcombank,
        bankAccount: '1234567890',
    ...
    test('should throw MaxLengthExceededCharException for too long postal code', () {
      // Arrange
      final data = VietQrData(
        bankBinCode: SupportedBank.vietcombank,
        bankAccount: '1234567890',
  ...
  group('Convenience Fee Validation Tests', () {
    ...
    test('should throw InvalidLengthException for invalid tip indicator length', () {
      // Arrange
      final testData = VietQrData.custom(
    ...
    test('should throw InvalidDataException for invalid tip indicator value', () {
      // Arrange
      final testData = VietQrData.custom(
