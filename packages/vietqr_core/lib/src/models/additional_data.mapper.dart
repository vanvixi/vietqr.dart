...
class AdditionalDataMapper extends ClassMapperBase<AdditionalData> {
  ...
  static const Field<AdditionalData, String> _f$billNumber =
      Field('billNumber', _$billNumber, opt: true, def: '');
  static String _$mobileNumber(AdditionalData v) => v.mobileNumber;
  static const Field<AdditionalData, String> _f$mobileNumber =
      Field('mobileNumber', _$mobileNumber, opt: true, def: '');
  static String _$storeLabel(AdditionalData v) => v.storeLabel;
  static const Field<AdditionalData, String> _f$storeLabel =
      Field('storeLabel', _$storeLabel, opt: true, def: '');
  static String _$loyaltyNumber(AdditionalData v) => v.loyaltyNumber;
  static const Field<AdditionalData, String> _f$loyaltyNumber =
      Field('loyaltyNumber', _$loyaltyNumber, opt: true, def: '');
  static String _$referenceLabel(AdditionalData v) => v.referenceLabel;
  static const Field<AdditionalData, String> _f$referenceLabel =
      Field('referenceLabel', _$referenceLabel, opt: true, def: '');
  static String _$customerLabel(AdditionalData v) => v.customerLabel;
  static const Field<AdditionalData, String> _f$customerLabel =
      Field('customerLabel', _$customerLabel, opt: true, def: '');
  static String _$terminalLabel(AdditionalData v) => v.terminalLabel;
  static const Field<AdditionalData, String> _f$terminalLabel =
      Field('terminalLabel', _$terminalLabel, opt: true, def: '');
  static String _$purpose(AdditionalData v) => v.purpose;
  static const Field<AdditionalData, String> _f$purpose =
      Field('purpose', _$purpose, opt: true, def: '');
  static String _$consumerRequest(AdditionalData v) => v.consumerRequest;
  static const Field<AdditionalData, String> _f$consumerRequest =
      Field('consumerRequest', _$consumerRequest, opt: true, def: '');
...
mixin AdditionalDataMappable {
  String toJson() {
    return AdditionalDataMapper.ensureInitialized()
        .encodeJson<AdditionalData>(this as AdditionalData);
  }

  Map<String, dynamic> toMap() {
    return AdditionalDataMapper.ensureInitialized()
        .encodeMap<AdditionalData>(this as AdditionalData);
  }
  ...
  AdditionalDataCopyWith<AdditionalData, AdditionalData, AdditionalData>
      get copyWith =>
          _AdditionalDataCopyWithImpl<AdditionalData, AdditionalData>(
              this as AdditionalData, $identity, $identity);
  @override
  String toString() {
    return AdditionalDataMapper.ensureInitialized()
        .stringifyValue(this as AdditionalData);
  }

  @override
  bool operator ==(Object other) {
    return AdditionalDataMapper.ensureInitialized()
        .equalsValue(this as AdditionalData, other);
  }

  @override
  int get hashCode {
    return AdditionalDataMapper.ensureInitialized()
        .hashValue(this as AdditionalData);
  }
}
