...
class VietQrDataMapper extends ClassMapperBase<VietQrData> {
  ...
  static const Field<VietQrData, String> _f$version =
  ...
  static const Field<VietQrData, String> _f$merchantCategory =
      Field('merchantCategory', _$merchantCategory, opt: true);
  static String _$currency(VietQrData v) => v.currency;
  static const Field<VietQrData, String> _f$currency =
      Field('currency', _$currency, opt: true);
  static String _$amount(VietQrData v) => v.amount;
  static const Field<VietQrData, String> _f$amount =
      Field('amount', _$amount, opt: true);
  static String _$tipOrConvenience(VietQrData v) => v.tipOrConvenience;
  static const Field<VietQrData, String> _f$tipOrConvenience =
      Field('tipOrConvenience', _$tipOrConvenience, opt: true);
  static String _$feeFixed(VietQrData v) => v.feeFixed;
  static const Field<VietQrData, String> _f$feeFixed =
      Field('feeFixed', _$feeFixed, opt: true);
  static String _$feePercentage(VietQrData v) => v.feePercentage;
  static const Field<VietQrData, String> _f$feePercentage =
      Field('feePercentage', _$feePercentage, opt: true);
  static String _$countryCode(VietQrData v) => v.countryCode;
  static const Field<VietQrData, String> _f$countryCode =
      Field('countryCode', _$countryCode, opt: true, def: kDefaultCountryCode);
  static String _$merchantName(VietQrData v) => v.merchantName;
  static const Field<VietQrData, String> _f$merchantName =
      Field('merchantName', _$merchantName, opt: true);
  static String _$merchantCity(VietQrData v) => v.merchantCity;
  static const Field<VietQrData, String> _f$merchantCity =
      Field('merchantCity', _$merchantCity, opt: true);
  static String _$postalCode(VietQrData v) => v.postalCode;
  static const Field<VietQrData, String> _f$postalCode =
      Field('postalCode', _$postalCode, opt: true);
  static AdditionalData _$additional(VietQrData v) => v.additional;
  static const Field<VietQrData, AdditionalData> _f$additional =
      Field('additional', _$additional, opt: true);
  static String _$initiationMethod(VietQrData v) => v.initiationMethod;
  static const Field<VietQrData, String> _f$initiationMethod =
      Field('initiationMethod', _$initiationMethod, mode: FieldMode.member);
...
mixin VietQrDataMappable {
  String toJson() {
    return VietQrDataMapper.ensureInitialized()
        .encodeJson<VietQrData>(this as VietQrData);
  }

  Map<String, dynamic> toMap() {
    return VietQrDataMapper.ensureInitialized()
        .encodeMap<VietQrData>(this as VietQrData);
  }

  VietQrDataCopyWith<VietQrData, VietQrData, VietQrData> get copyWith =>
      _VietQrDataCopyWithImpl<VietQrData, VietQrData>(
          this as VietQrData, $identity, $identity);
  @override
  String toString() {
    return VietQrDataMapper.ensureInitialized()
        .stringifyValue(this as VietQrData);
  }

  @override
  bool operator ==(Object other) {
    return VietQrDataMapper.ensureInitialized()
        .equalsValue(this as VietQrData, other);
  }
...
class _VietQrDataCopyWithImpl<$R, $Out>
  ...
  @override
  AdditionalDataCopyWith<$R, AdditionalData, AdditionalData> get additional =>
      ($value.additional as AdditionalData)
          .copyWith
          .$chain((v) => call(additional: v));
  @override
  $R call(
          {Object? version = $none,
          MerchantAccountInfoData? merchantAccInfo,
