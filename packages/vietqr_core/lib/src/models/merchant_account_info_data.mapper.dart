...
class MerchantAccountInfoDataMapper
  ...
  static MerchantAccountInfoDataMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = MerchantAccountInfoDataMapper._(),
      );
  ...
  static const Field<MerchantAccountInfoData, String> _f$globalUid = Field(
    'globalUid',
    _$globalUid,
    opt: true,
    def: kNapasAID,
...
mixin MerchantAccountInfoDataMappable {
  ...
  String toString() {
    return MerchantAccountInfoDataMapper.ensureInitialized().stringifyValue(
      this as MerchantAccountInfoData,
    );
  }

  @override
  bool operator ==(Object other) {
    return MerchantAccountInfoDataMapper.ensureInitialized().equalsValue(
      this as MerchantAccountInfoData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MerchantAccountInfoDataMapper.ensureInitialized().hashValue(
      this as MerchantAccountInfoData,
    );
  }
}
...
class _MerchantAccountInfoDataCopyWithImpl<$R, $Out>
  ...
  MerchantAccountInfoData $make(CopyWithData data) =>
      MerchantAccountInfoData.custom(
        ...
        beneficiaryOrgData: data.get(
          #beneficiaryOrgData,
          or: $value.beneficiaryOrgData,
        ),
